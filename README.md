Хорошо, вот подробное описание проекта для вашего `README.md` файла. Вы можете скопировать этот текст и вставить его в `README.md` в корневой папке вашего проекта.
